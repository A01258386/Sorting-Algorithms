...
def draw(draw_info, algo_name, ascending):
	...
	keys = draw_info.FONT.render("ENTER - Sort, N - New Blocks, A - Ascending, D - Descending", 1, draw_info.WHITE)
	draw_info.window.blit(keys, (draw_info.width/2 - keys.get_width()/2 , 45))
